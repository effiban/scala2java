...
class DeprecatedWhileTraverserImplTest extends UnitTestSuite {
  ...
  private val whileTraverser = new DeprecatedWhileTraverserImpl(expressionTermTraverser, blockTraverser)
