...
class DeprecatedTermApplyTraverserImplTest extends UnitTestSuite {
  private val expressionTermTraverser = mock[DeprecatedExpressionTermTraverser]
  private val arrayInitializerTraverser = mock[DeprecatedArrayInitializerTraverser]
  private val argListTraverser = mock[DeprecatedArgumentListTraverser]
  private val invocationArgTraverser = mock[DeprecatedArgumentTraverser[Term]]
  ...
  private val termApplyTraverser = new DeprecatedTermApplyTraverserImpl(
