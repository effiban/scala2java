...
class TemplateChildContextMockitoMatcher(expectedContext: TemplateChildContext) extends ArgumentMatcher[TemplateChildContext] {
...
object TemplateChildContextMockitoMatcher {
  def eqTemplateChildContext(expectedContext: TemplateChildContext): TemplateChildContext = argThat(new TemplateChildContextMockitoMatcher(expectedContext))
}
