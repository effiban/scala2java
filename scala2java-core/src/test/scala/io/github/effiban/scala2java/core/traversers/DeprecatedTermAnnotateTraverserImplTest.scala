...
class DeprecatedTermAnnotateTraverserImplTest extends UnitTestSuite {
  ...
  private val termAnnotateTraverser = new DeprecatedTermAnnotateTraverserImpl(annotListTraverser, expressionTermTraverser)
