...
class TermApplyTransformationContextMockitoMatcher(expectedContext: TermApplyTransformationContext)
  extends ArgumentMatcher[TermApplyTransformationContext] {
...
object TermApplyTransformationContextMockitoMatcher {
  def eqTermApplyTransformationContext(
    expectedContext: TermApplyTransformationContext): TermApplyTransformationContext =
