...
class DeprecatedExpressionTermRefTraverserImplTest extends UnitTestSuite {

  private val termNameTraverser = mock[DeprecatedTermNameTraverser]
  private val termSelectTraverser = mock[DeprecatedExpressionTermSelectTraverser]
  private val applyUnaryTraverser = mock[DeprecatedApplyUnaryTraverser]
  ...
  private val expressionTermRefTraverser = new DeprecatedExpressionTermRefTraverserImpl(
    termNameTraverser,
    termSelectTraverser,
    applyUnaryTraverser,
