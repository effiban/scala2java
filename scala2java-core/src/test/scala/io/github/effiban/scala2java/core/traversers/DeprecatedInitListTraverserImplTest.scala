...
class DeprecatedInitListTraverserImplTest extends UnitTestSuite {

  private val argumentListTraverser = mock[DeprecatedArgumentListTraverser]
  private val initArgTraverserFactory = mock[DeprecatedInitArgTraverserFactory]
  private val initArgTraverser = mock[DeprecatedInitArgumentTraverser]

  private val initListTraverser = new DeprecatedInitListTraverserImpl(argumentListTraverser, initArgTraverserFactory)
