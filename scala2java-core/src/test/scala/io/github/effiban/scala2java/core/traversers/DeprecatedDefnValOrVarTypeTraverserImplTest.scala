...
class DeprecatedDefnValOrVarTypeTraverserImplTest extends UnitTestSuite {
  ...
  private val defnValOrVarTypeTraverser = new DeprecatedDefnValOrVarTypeTraverserImpl(
    typeTraverser,
    typeRenderer,
    termTypeInferrer
  )
