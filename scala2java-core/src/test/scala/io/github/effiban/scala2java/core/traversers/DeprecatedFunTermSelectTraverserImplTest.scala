...
class DeprecatedFunTermSelectTraverserImplTest extends UnitTestSuite {
  ...
  private val qualifierTraverser = mock[DeprecatedTermTraverser]
  private val termNameRenderer = mock[TermNameRenderer]
  private val typeTraverser = mock[TypeTraverser]
  private val typeListRenderer = mock[TypeListRenderer]

  private val funTermSelectTraverser = new DeprecatedFunTermSelectTraverserImpl(
    qualifierTraverser,
    termNameRenderer,
    typeTraverser,
    typeListRenderer,
