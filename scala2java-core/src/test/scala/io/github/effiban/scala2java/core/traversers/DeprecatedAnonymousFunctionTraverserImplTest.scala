...
class DeprecatedAnonymousFunctionTraverserImplTest extends UnitTestSuite {

  private val termFunctionTraverser = mock[DeprecatedTermFunctionTraverser]

  private val anonymousFunctionTraverser = new DeprecatedAnonymousFunctionTraverserImpl(termFunctionTraverser)
