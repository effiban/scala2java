...
class NonTermStatTraverserImplTest extends UnitTestSuite {
  ...
  private val nonTermStatTraverser = new NonTermStatTraverserImpl(
    importTraverser,
    importRenderer,
    pkgTraverser,
    defnTraverser,
  ...
  test("traverse Import when traverser returns an import") {
    ...
    nonTermStatTraverser.traverse(`import`, StatContext(Package))
  ...
  test("traverse Pkg") {
    ...
    nonTermStatTraverser.traverse(pkg, StatContext(JavaScope.Unknown))
  ...
  test("traverse Defn.Val") {
    ...
    nonTermStatTraverser.traverse(defnVal, StatContext(JavaScope.Block))
  ...
  test("traverse Decl.Val") {
    ...
    nonTermStatTraverser.traverse(declVal, StatContext(JavaScope.Block))
