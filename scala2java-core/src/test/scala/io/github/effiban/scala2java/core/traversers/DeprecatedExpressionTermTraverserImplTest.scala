...
class DeprecatedExpressionTermTraverserImplTest extends UnitTestSuite {
  ...
  private val expressionTermRefTraverser = mock[DeprecatedExpressionTermRefTraverser]
  private val defaultTermTraverser = mock[DeprecatedDefaultTermTraverser]

  private val expressionTraverser = new DeprecatedExpressionTermTraverserImpl(
    ifTraverser,
    statTraverser,
    termApplyTraverser,
