...
class DeprecatedSimpleArgumentTraverserTest extends UnitTestSuite {

  private val treeTraverser = mock[ScalaTreeTraverser[Tree]]
  private val argContext = mock[ArgumentContext]

  private val simpleArgumentTraverser = new DeprecatedSimpleArgumentTraverser(treeTraverser)
