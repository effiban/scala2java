...
class DeprecatedExpressionTermSelectTraverserImplTest extends UnitTestSuite {
  ...
  private val termSelectTraverser = new DeprecatedExpressionTermSelectTraverserImpl(
