...
class DeprecatedBlockTraverserImplTest extends UnitTestSuite {
  ...
  private val blockStatTraverser = mock[DeprecatedBlockStatTraverser]

  private val blockTraverser = new DeprecatedBlockTraverserImpl(initTraverser, blockStatTraverser)
