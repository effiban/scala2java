...
// TODO - remove once Term.Name-s are fully qualified at start of flow
@deprecated
class DeprecatedCoreTermApplyTransformerTest extends UnitTestSuite {
  ...
  private val termApplyTransformer = new DeprecatedCoreTermApplyTransformer(
    termNameClassifier,
    typeClassifier,
