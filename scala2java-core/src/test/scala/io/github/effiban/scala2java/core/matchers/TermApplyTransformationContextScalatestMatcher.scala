...
class TermApplyTransformationContextScalatestMatcher(expectedContext: TermApplyTransformationContext) extends Matcher[TermApplyTransformationContext] {
...
object TermApplyTransformationContextScalatestMatcher {
  def equalTermApplyTransformationContext(expectedContext: TermApplyTransformationContext): Matcher[TermApplyTransformationContext] =
