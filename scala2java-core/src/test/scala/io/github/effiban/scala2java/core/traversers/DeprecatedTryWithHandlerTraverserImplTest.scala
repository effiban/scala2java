...
class DeprecatedTryWithHandlerTraverserImplTest extends UnitTestSuite {
  ...
  private val tryWithHandlerTraverser = new DeprecatedTryWithHandlerTraverserImpl(blockTraverser, finallyTraverser)
