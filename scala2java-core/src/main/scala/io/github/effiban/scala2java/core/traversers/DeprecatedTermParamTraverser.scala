...
@deprecated
trait DeprecatedTermParamTraverser {
  def traverse(termParam: Term.Param, context: StatContext): Unit
}

@deprecated
private[traversers] class DeprecatedTermParamTraverserImpl(modListTraverser: => DeprecatedModListTraverser,
                                                           typeTraverser: => TypeTraverser,
                                                           typeRenderer: => TypeRenderer,
                                                           nameTraverser: NameTraverser,
                                                           nameRenderer: NameRenderer)
                                                          (implicit javaWriter: JavaWriter) extends DeprecatedTermParamTraverser {
