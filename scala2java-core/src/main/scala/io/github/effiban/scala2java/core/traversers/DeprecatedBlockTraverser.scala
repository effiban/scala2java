...
@deprecated
trait DeprecatedBlockTraverser {
...
@deprecated
private[traversers] class DeprecatedBlockTraverserImpl(initTraverser: => DeprecatedInitTraverser,
                                                       blockStatTraverser: => DeprecatedBlockStatTraverser)
                                                      (implicit javaWriter: JavaWriter) extends DeprecatedBlockTraverser {
