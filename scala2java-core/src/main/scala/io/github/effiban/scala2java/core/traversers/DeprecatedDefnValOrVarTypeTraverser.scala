...
@deprecated
trait DeprecatedDefnValOrVarTypeTraverser {
...
@deprecated
private[traversers] class DeprecatedDefnValOrVarTypeTraverserImpl(typeTraverser: => TypeTraverser,
                                                                  typeRenderer: => TypeRenderer,
                                                                  termTypeInferrer: => TermTypeInferrer)
                                                                 (implicit javaWriter: JavaWriter) extends DeprecatedDefnValOrVarTypeTraverser {
