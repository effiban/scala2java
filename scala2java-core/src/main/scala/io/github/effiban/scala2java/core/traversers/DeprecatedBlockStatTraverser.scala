...
@deprecated
trait DeprecatedBlockStatTraverser {
...
@deprecated
private[traversers] class DeprecatedBlockStatTraverserImpl(ifTraverser: => DeprecatedIfTraverser,
                                                          ...
                                                          (implicit javaWriter: JavaWriter) extends DeprecatedBlockStatTraverser {
