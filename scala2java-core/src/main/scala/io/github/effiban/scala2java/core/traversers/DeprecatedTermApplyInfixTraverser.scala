...
@deprecated
trait DeprecatedTermApplyInfixTraverser extends ScalaTreeTraverser[Term.ApplyInfix]

@deprecated
private[traversers] class DeprecatedTermApplyInfixTraverserImpl(expressionTermTraverser: => DeprecatedExpressionTermTraverser,
                                                               ...
                                                               (implicit javaWriter: JavaWriter) extends DeprecatedTermApplyInfixTraverser {
