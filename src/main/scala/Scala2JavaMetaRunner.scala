...
object Scala2JavaMetaRunner {
  ...
  object Scala2JavaTraverser {
    val javaEmitter = new JavaEmitter
    ...
    private case object NoContext extends JavaOwnerContext
    ...
    private var javaOwnerContext: JavaOwnerContext = NoContext
