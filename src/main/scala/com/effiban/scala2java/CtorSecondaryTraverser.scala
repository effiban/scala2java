...
import com.effiban.scala2java.transformers.CtorSecondaryTransformer
...
private[scala2java] class CtorSecondaryTraverserImpl(ctorSecondaryTransformer: CtorSecondaryTransformer,
