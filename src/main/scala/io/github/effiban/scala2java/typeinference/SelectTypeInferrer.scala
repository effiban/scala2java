...
import io.github.effiban.scala2java.entities.TermNameValues.{Empty, ScalaInclusive}
import io.github.effiban.scala2java.entities.{TermNameValues, TypeNameValues}
